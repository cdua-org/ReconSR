...
func TestParseDS(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			"\\# 20 0d6d08021234567890abcdef1234567890abcdef", // 0d6d = 3437, 08 = RSA/SHA256, 02 = SHA-256
...
func TestGetDSDataEmpty(t *testing.T) {
	execution := getDSData("example.com")
...
func TestGetDSDataNX(t *testing.T) {
	execution := getDSData("nonexistent.domain.invalid")
