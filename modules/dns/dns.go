...
func (m *module) Capabilities() (schema.ModuleCapabilities, error) {
	return schema.ModuleCapabilities{
		Functions:  []string{"get_ip", "get_caa", "get_ns", "get_soa", "get_cname", "check_wildcard", "get_domainkey", "get_dmarc", "get_dkim", "get_mx", "get_txt", "get_srv", "get_nsec", "get_loc", "get_hinfo", "get_rp", "get_uri", "get_svcb", "get_sshfp", "get_naptr", "get_tlsa", "get_dnskey", "get_ds", "get_cert", "get_openpgpkey", "get_hip", "get_ipseckey"},
...
func (m *module) Exec(data schema.ModuleInput) (schema.ModuleOutput, error) {
	...
	for _, f := range data.Functions {
		...
		case "get_dnskey":
			execution = getDNSKEYData(data.Target.Value)
		case "get_ds":
			execution = getDSData(data.Target.Value)
		case "get_cert":
			execution = getCERTData(data.Target.Value)
		case "get_openpgpkey":
			execution = getOPENPGPKEYData(data.Target.Value)
		case "get_hip":
			execution = getHIPData(data.Target.Value)
		case "get_ipseckey":
			execution = getIPSECKEYData(data.Target.Value)
		default:
